...
public class MoveToDistanceEncoder extends PIDCommand {
  // This will turn to a fixed angle determined by where the gyro was set to zero  
  public MoveToDistanceEncoder( double targetDistanceInches, DriveTrain drive, boolean relativeDistance) {
    super( 
         new PIDController(DriveConstants.kDriveP, DriveConstants.kDriveI, DriveConstants.kDriveD),
          ...
          targetDistanceInches+(relativeDistance ? drive.getAverageDistance() : 0),
